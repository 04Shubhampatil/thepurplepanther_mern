 ...
 *
 * The `.swiper-slide` wrapper the Blade partial included is gone: swiper/react emits its
 * own `<SwiperSlide>` around this, and a second one would nest a slide inside a slide.
 */
    ...
    >
      <div className="card-product-wrapper position-relative">
        <Link to={item.url} className="product-img overflow-hidden">
          ...
          <img className="w-100 img-hover" loading="lazy" src={item.hoverImage} alt={item.title} />
        </Link>
